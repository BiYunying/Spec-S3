...
class FG26(QM9_geometric):
    def __init__(self, root, transform=None, dataset_arg=None):
        ...
        super(FG26, self).__init__(root, transform=transform)

    @property
    def processed_file_names(self) -> str:
        # return "data_with_uv_ir_raman_token_ids_subset.pt"
        # return "data_with_uv_ir_raman_token_ids.pt"
        return "fg26_uv_ir_raman_smiles_aligned.pt"
        # return "data_with_uv_ir_raman_smiles_subset.pt"
...
if __name__ == "__main__":
    dataset = FG26(root="~/datasets//qm9sp", dataset_arg="homo")
    print(dataset)
    print(dataset[0])
